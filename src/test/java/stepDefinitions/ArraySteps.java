...
public class ArraySteps {
	...
	public void the_user_is_on_the_python_editor_of_practice_page() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	@When("The user clicks the Run Button without entering the code in the Editor of Practice Page")
	public void the_user_clicks_the_run_button_without_entering_the_code_in_the_editor_of_practice_page() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("Nothing happens to the page and no error message is displayed in Practice Page")
	public void nothing_happens_to_the_page_and_no_error_message_is_displayed_in_practice_page() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("The user write the invalid code in Editor of Practice Page Click the Run Button")
	public void the_user_write_the_invalid_code_in_editor_of_practice_page_click_the_run_button() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("The user should able to see an error message in alert window of Practice Page")
	public void the_user_should_able_to_see_an_error_message_in_alert_window_of_practice_page() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void the_user_should_able_to_see_output_in_the_console_of_practice_page() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
